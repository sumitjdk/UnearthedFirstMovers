...
// Data
var data = [];
dataBuilder(JSON.parse(fs.readFileSync(path.join(__dirname, '/data/categories/art_galleries1.geojson'), 'utf8')), 'art');
dataBuilder(JSON.parse(fs.readFileSync(path.join(__dirname, '/data/categories/art_galleries2.geojson'), 'utf8')), 'music');
dataBuilder(JSON.parse(fs.readFileSync(path.join(__dirname, '/data/categories/art_galleries3.geojson'), 'utf8')), 'museum');
dataBuilder(JSON.parse(fs.readFileSync(path.join(__dirname, '/data/categories/art_galleries4.geojson'), 'utf8')), 'theatre');
...
var bounds = [
  [-78.636475, 47.024213], // Southwest coordinates
  [-64.520255, 57.340692]  // Northeast coordinates
];

var map = new mapboxgl.Map({
  container: 'map',
  style: 'mapbox://styles/sumitjdk/cizu1zmbs005t2rlr0y4iovk4',
  hash: true,
  center: [-78.205734, 48.084822],
  zoom: 10,
  maxBounds: bounds
});
